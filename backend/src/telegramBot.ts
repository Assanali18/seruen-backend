...
// import buyTickets from './draft/buyTickets';
...
// const availableCommands = ['/start', '/change_budget', '/change_hobbies', '/change_preferences', '/stop_session', '/next_event', '/view_preferences'];

// const hobbiesOptions = [
//   { text: '🎵 Музыка', callback_data: 'hobby_music' },
//   { text: '🎨 Искусство', callback_data: 'hobby_art' },
//   { text: '🏃 Спорт', callback_data: 'hobby_sport' },
//   { text: '🌍 Путешествия', callback_data: 'hobby_travel' },
//   { text: '🍲 Еда', callback_data: 'hobby_food' },
//   { text: '🎭 Театр', callback_data: 'hobby_theater' },
//   { text: '🎤 Комедия', callback_data: 'hobby_comedy' },
//   { text: '🎉 Фестиваль', callback_data: 'hobby_festival' },
//   { text: '🛠️ Развитие', callback_data: 'hobby_development' },
// ];

// const createHobbiesKeyboard = (selectedHobbies: string[]) => {
//   return {
//     inline_keyboard: [
...
// bot.onText(/\/change_preferences/, async (msg) => {
//   const chatId = msg.chat.id;
...
//     await bot.editMessageText('Ваши увлечения сохранены.', { chat_id: chatId, message_id: callbackQuery.message.message_id });
...
//         await bot.sendMessage(chatId, 'Начался поиск в базе данных по вашему запросу... Если ивенты не придут в течении 2 минут, попробуйте ввести другой запрос или напишите @us_sun.');
